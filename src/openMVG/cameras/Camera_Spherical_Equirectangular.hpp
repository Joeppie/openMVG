...
/**
 * @brief Implement a Spherical_Equirectangular camera model
 */
class Intrinsic_Spherical_Equirectangular : public IntrinsicBase {
...
using  class_type = Intrinsic_Spherical_Equirectangular;
  ...
  * @retval CAMERA_SPHERICAL_EQUIRECTANGULAR
  */
  virtual EINTRINSIC getType() const override
  {
    return CAMERA_SPHERICAL_EQUIRECTANGULAR;
  }
